...
{
    explicit BatteryMeasurementObjects(
        const adc::AdcIf::PinId pin_id,
...
static BatteryMeasurementObjects _battery_measurement_objects {battery_pin_id, battery_conversion_factor};
