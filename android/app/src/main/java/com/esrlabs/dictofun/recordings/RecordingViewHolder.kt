...
class RecordingViewHolder(itemView: View) : GroupViewHolder(itemView) {
    private val recordingName: TextView = itemView.findViewById(com.esrlabs.dictofun.R.id.recording_name)
...
class TranslationViewHolder(itemView: View) : ChildViewHolder(itemView) {
    private val artistName: TextView = itemView.findViewById(com.esrlabs.dictofun.R.id.transcription_item)
